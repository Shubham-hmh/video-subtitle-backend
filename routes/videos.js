...
// router.post('/upload-with-subtitles', upload.single('video'), async (req, res) => {
//   try {
...
//     const subtitleObjects = subtitles.map((subtitle) => {
//       if (subtitle && subtitle.text && subtitle.timestamp) {
//         return {
//           videoId: savedVideo._id,
//           text: subtitle.text,
//           timestamp: subtitle.timestamp,
...
//         };
//       } else {
//         return null; // Invalid subtitle object
//       }
//     }).filter(Boolean); // Remove any null entries (invalid subtitles)
